...
function update(location) {
  monsterStatsElement.style.display = "none";
...
function goFight() {
  ...
  // game screen
  monsterStatsElement.style.display = "block";
  monsterName.innerText = monsters[fighting].name;
  monsterHealthText.innerText = monsterHealth;
}

// function inner go Store
function buyHealth() {
  if (gold >= 10) {
    gold -= 10;
    health += 10;
...
function attack() {
  ...
  healthTextElement.innerText = health;
  monsterHealthText.innerText = monsterHealth;
  // prosses attack
  if (health <= 0) {
    lose();
...
function defeatMonster() {
  ...
  // update game screen
  goldTextElement.innerText = gold;
  xpTextElement.innerText = xp;
...
function pick(guess) {
  ...
  text.innerText = "You picked " + [guest] + ". Here are the random numbers:\n";
  for (let i = 0; i < 10; i++) {
